 ...
 */
 window.jQuery&&window.via||function(g,la,j){function I(c){this.context=r(c||"",!0)}function v(c){return"object"===typeof c}function n(c){return"string"===typeof c}function R(c){return null===c||typeof c in Ja}function S(c){return c===j}function x(c,a){0===a&&(a="0");var b,d,e=J,f=T(c,a),g=r(f,!0),h=g.split(".");if(1===h.length)d=g;else{d=h[h.length-1];for(b=0;b<h.length-1&&!(e=e[h[b]],e===j);b++);}if(R(e))throw"invalid access proxy using path:"+f;return{physicalPath:g,logicalPath:f,hostObj:e,index:d}}
...
this.target=a,this.eventType=b,!S(d)&&(this.proposed=d),!S(e)&&(this.removed=e))}function sa(c,a,b){n(a)&&a.beginsWith("*")&&(a=w[a.substring(1)]);o(a.buildOptions)&&(b=a.buildOptions.call(c,b));return b}function fa(c){g(c).data(l,!0)}function W(c){return!0===g(c).data(l)}function K(c,a,b,d){v(c)?i(this,c):(this.path=c,this.options=a,this.e=b,this.triggerData=d)}function Oa(c,a){var b=c.data,d=new K(b.path,b.options,c,a),b=b.viewHandler;if(o(b))return X(d,b.call(this,d));if(n(b)){var e=b.substring(1),
f=b.substring(2);if(b.beginsWith("*")){if(e=L[e]){e.call(this,d);return}}else if(b.beginsWith("$")){if(o(A[e]))return X(d,"css,attr,prop".contains(e)?g(this)[e](d.options||d.targetIndex()):g(this)[e]())}else if(b.beginsWith("p.")){if(o(D[f])){d.targetProxy()[f](d);return}}else if(b.beginsWith("v.")){if(e=this[f],o(e))return X(d,e.call(this,d))}else if(b.beginsWith("m.")&&(e=k.get(!0,f),o(e)))return X(d,e.call(this,d))}throw"view handler: '"+b+"' not found";}function X(c,a){if(a!==j){var b=c.options;
n(b)&&b.beginsWith("*")&&(b=ga[b.substring(1)])&&(a=b(a));k.update(c.path,a)}}function ta(c){var a=c.data,b=g(c.target).data("via");(b=b&&b.viewEvents&&b.viewEvents[a])&&g(c.target).trigger(i({},c,{type:a+"."+b,currentTarget:c.target}))}function ua(c){if(!n(c))throw"bindingText must non-empty string";for(var a={},b,d;b=Pa.exec(c);)d=b[1],b=b[3]&&g.trim(b[3])||!0,a[d]=a[d]?a[d]+";"+b:b;return a}function Qa(c){if(!c)return!1;var a;a:{a=c+".";for(var b in M)if(b.beginsWith(a)){a=!0;break a}a=!1}if(a)return!0;
a=va(c);if(!a)return!1;b=0;for(var d;d=a[b];b++)for(var e in d){var f=d[e],g=c+"."+e;M[g]=M[g]?M[g]+f:f}return!0}function va(c){var a=h.themes[c];if(a){c=[];a.bindingSet&&c.push(a.bindingSet);if(a=a.subThemes)for(var a=a.split(";"),b=0;b<a.length;b++)c=c.concat(va(a[b]));return c}}function wa(c,a,b){if(a[N]&&"_"!==a[N]&&Qa(a.theme))for(var d=a[N].split(Ra),e,f=0;f<d.length;f++){var g=Sa.exec(d[f]);if(e=M[a.theme+"."+g[1]]){e=ua(e);e.path=xa(a.path,g[3]);e.theme=a.theme;e.options=g[5]||a.options;wa(c,
...
"_")}var h=la.via=function(c){return new I(c)},i=g.extend,J={},O=g.isArray,Xa=g.isPlainObject,o=g.isFunction,La=/this\.((?:\.?\w+)+)/g,Ja={undefined:j,"boolean":j,number:j,string:j},l="__via",Ya=/__via\.(\w+)/,Ka=/__via\.(\w+)(\.(.+))*/,m={},q={},k,ma=J[l]={},ca=/_/g,ba=/\./g,z=J.hasOwnProperty,u=Array.prototype,ia=u.slice,s,D=I.prototype={};u.indexOf=u.indexOf||function(c,a){for(var b=a||0;b<this.length;b++)if(this[b]==c)return b;return-1};u.contains=u.contains||function(c){return-1!==this.indexOf(c)};
u.remove=u.remove||function(c){c=this.indexOf(c);-1!=c&&this.splice(c,1);return this};u.pushUnique=u.pushUnique||function(c){this.contains(c)||this.push(c);return this};u.sortObject=u.sortObject||function(c,a){a=S(a)?!0:!1;c?this.sort(function(b,d){var e=b[c],f=d[c];return e==f?0:a?e>f?1:-1:e>f?-1:1}):a?this.sort():this.sort().reverse()};var $=String.prototype;$.beginsWith=$.beginsWith||function(c){return 0===this.indexOf(c)};$.contains=$.contains||function(c){return-1!==this.indexOf(c)};i(D,{version:"0.2pre",
...
a);throw"oldItem not found";},removeItem:function(c){c=this.indexOf(c);return-1!==c?this.removeAt(c):this},clear:function(){var c=this.get();c.splice(0,c.length);s(this.context,this.context,"init");return this},count:function(){return this.get().length},sort:function(c,a){return h.raiseEvent(this.context,this.context,"init",this.get().sortObject(c,a))}});U.prototype={constructor:U,mainModel:function(){return k.get(this.mainPath)}};i(h,{fn:D,accessor:x,toPhysicalPath:r,toLogicalPath:na,clearObj:function a(b){if(R(b))return null;
for(var d in b)z.call(b,d)&&(b[d]=a(b[d]));return b},isUndefined:S,isPrimitive:R,isString:n,isObject:v,shadowNamespace:function(){return l},Shadow:U,modelCleanups:[function(a){for(var b in m)m[b].remove(a),0===m[b].length&&delete m[b];for(var d in m)d.beginsWith(a)&&delete m[d];a.beginsWith(l)||k.del(l+"."+a.replace(ba,"_"))}],addRef:function(a,b){a=r(a);b=r(b);m[b]=m[b]||[];m[b].pushUnique(a);return this},removeRef:function(a,b){a=r(a);b=r(b);m[b].remove(a);m[b].length||delete m[b];return this},
modelReferences:m,options:function(a,b){if(a===j)return q;if(v(a))return i(q,a),a;if(1===arguments.length)return q[a];if(b===j)delete q[a];else return q[a]=b},getAll:function(){var a=i({},J);delete a[l];return a},empty:function(){for(var a in J)a!==l&&k.del(a,!0)}});k=new I("");var Ma=/(\w+)?(\*?)(\.?)([^\s]*)/,Za=/^(.+)\.\w+$/,$a=/^.+\.(\w+)$|\w+/,ea={},B=la.RegExp,p={},w={},ra=/\s*\|\s*/,Na=/^\w+(?!\w*\.\w+)/,ab=/^(\w+)\.?/,A=g.fn;s=function(a,b,d,e,f){a=new C(a,b,d,e,f);pa(a);if(a.continueEventing&&
a.bubbleUp)for(a.eventType=ab.exec(a.eventType)[1]+".child";((b=h.contextOfPath(a.path))||1)&&!(a.path=b,pa(a),!a.continueEventing||!a.bubbleUp||""===b););return a};C.prototype={constructor:C,targetProxy:function(){return h(this.target)},targetValue:function(a){return h().get(a,this.target)},targetContext:function(){return h.contextOfPath(this.target)},targetIndex:function(){return h.indexOfPath(this.target)},bubbleUp:!0,continueEventing:!0,hasError:!1,currentValue:function(a){return h().get(a,this.path)},
currentProxy:function(){return h(this.path)},isModelEmpty:function(){var a=this.options,a=a?n(a)?"true"===a:!!a:!1;return this.currentProxy().isModelEmpty(a)}};fa(ea);i(h,{addModelHandler:function(a,b,d,e,f){if("once"===b)return this.renderViews(a,d,e,f);if(n(d)||o(d))f=e,e=d,d=ea;"_"===f&&(f=j);a=r(a,!0);d=g(d);0<d.length&&!p[a]&&(p[a]=[]);d.each(function(){f=sa(this,e,f);fa(this);p[a].push({view:this,modelHandler:e,modelEvents:b,options:f});qa(b,"init")&&da(this,e,new C({path:a,target:a,eventType:"init",
options:f}))});return h},removeModelHandler:function(a){if(n(a)){var a=r(a),b;for(b in p)b.beginsWith(a)&&delete p[b]}else v(a)&&g(a).each(function(a,b){if(W(b))for(var f in p){for(var g=p[f],h=g.length-1;0<=h;h--)g[h].view===b&&g.splice(h,1);0===g.length&&delete p[f]}});return h},getModelHandlerData:function(a){if(n(a))return p[r(a)];if(v(a)){if(!W(a))return;var b={},d;for(d in p)for(var e=p[d],f=e.length-1;0<=f;f--)e[f].view===a&&(b[d]=b[d]||[],b[d].push(e[f]));return b}if(!a)return p},renderViews:function(a,
b,d,e){a=r(a,!0);g(b).each(function(){e=sa(this,d,e);da(this,d,new C({path:a,target:a,eventType:"init",options:e}))});return h},ModelEvent:C,commonModelHandlers:w,raiseEvent:s,indexOfPath:function(a){a=$a.exec(a);return a[1]||a[0]},contextOfPath:function(a){return(a=Za.exec(a))&&a[1]||""}});h.modelCleanups.push(h.removeModelHandler);A.addModelHandler=function(a,b,d,e){h.addModelHandler(a,b,this,d,e);return this};A.renderViews=function(a,b,d){h.renderViews(a,this,b,d);return this};var L={},ga={},t=
{};K.prototype={constructor:K,targetProxy:function(){return h(this.path)},targetValue:function(a){return k.get(a,this.path)},targetContext:function(){return h.contextOfPath(this.path)},targetIndex:function(){return h.indexOfPath(this.path)},updateModel:function(a){return k.update(this.path,a)},returnFalse:function(){this.e.stopPropagation();this.e.preventDefault()},stopPropagation:function(){this.e.stopPropagation()},stopImmediatePropagation:function(){this.e.stopImmediatePropagation()}};i(h,{addViewHandler:function(a,
b,d,e,f){var d=r(d,!0),i=e;"_"===f&&(f=j);n(e)&&e.beginsWith("*")&&(e=L[e.substring(1)]);o(e.buildOptions)&&(f=e.buildOptions(a,f));o(e.initialize)&&e.initialize(a);b=g.map(b.split(ra),function(a){return a+"."+l+"."+d}).join(" ");g(a).each(function(){fa(this);g(this).bind(b,{viewHandler:e,path:d,options:f,originalHandler:i},Oa);t[d]=t[d]||[];t[d].pushUnique(this)});return h},removeViewHandler:function(a){n(a)?(a=r(a),g(t[a]).unbind("."+l+"."+a),delete t[a]):v(a)&&(g(a).unbind("."+l),g(a).each(function(){for(var a in t)t[a].remove(this)}));
return h},removeView:function(a){g(a).each(function(a,d){W(this)&&(h.removeModelHandler(d).removeViewHandler(d),g(this).removeData(l))});return h},commonViewHandlers:L,valueConverters:ga,ViewEvent:K,getViewHandlerData:function(a){if(n(a))return t[a];if(v(a)){if(!W(a))return;var b=[],d;for(d in t)z.call(t,d)&&t[d].contains(a)&&b.push(d);return b}if(!a)return t},getHandlerData:function(a){var b=h.getModelHandlerData(a),d=h.getViewHandlerData(a);return n(a)?{viewsToBeUpdated:b,viewsUpdatingMe:d}:{modelsUpdatingMe:b,
modelsToBeUpdated:d}}});h.modelCleanups.push(h.removeViewHandler);var bb=g.cleanData;g.cleanData=function(a){h.removeView(a);bb(a)};h.forwardEvent=function(a,b,d){var e=function(a){d(a)&&g(a.target).trigger(i({},a,{type:b,currentTarget:a.target}))};if(g.event.special[b])throw"event '"+b+"' has been defined";g.event.special[b]={setup:function(){g(this).bind(a,e)},teardown:function(){g(this).unbind(a,e)}};return h};h.addViaEvent=function(a,b){g.event.special[a]={setup:function(){g(this).bind(b,a,ta)},
teardown:function(){g(this).unbind(b,ta)}};return h};A.addViewHandler=function(a,b,d,e){h.addViewHandler(this,a,b,d,e);return this};var ja=/^[\.\*]\w+/,Ga=/^\.([\.\*])/,Ta=/\s+/g,Pa=/\s*@(\w+)(:([^@]+))*/g,Ra=/\s*;\s*/g,Sa=/(.+?)(,(.+?))?(,(.+))*$/,Ua=/(.+?),(.+?),(.+?)(,(.+))*$/,N="class",Va="mh,vh,class,theme,path,options".split(","),M={},aa={},y,P;q.theme="via";var xa=h.mergePath=function(a,b){if(!b||"."==b)return a;if(Ga.test(b))return b.replace(Ga,h.contextOfPath(a)+"$1");if(ja.test(b)){var d=
/^(.+)\*/.exec(a);return d&&d[1]&&b.beginsWith("*")?d[1]+b:b.replace(ja,a+"$&")}return b};i(h,{specialParsers:y={},classMatchers:aa,view:function(a){return g(a||":via").each(function(){if(!g(this).data("via")){var a;if(a=g(this).attr("via")){a=ua(a);g(this).data("via",a);if(a.path&&"."!==a.path){if(ja.exec(a.path))a.path=za(this)+a.path}else a.path=za(this);a.theme=a.theme||q.theme;var d={mh:[],vh:[]},e=a,f=N,i;if(!(i=a[N]))b:{for(var j in aa)if(z.call(aa,j)&&aa[j](this)){i=j;break b}i=void 0}e[f]=
i;wa(this,a,d);e=a;Y("mh",this,e,d);Y("vh",this,e,d);ya(this,a,d);a=d}else a=void 0;if(a){d=a.mh;e=a.vh;for(a=0;a<d.length;a++)f=d[a],h.addModelHandler(f.path,f.modelEvents,f.view,f.modelHandler,f.options);for(a=0;a<e.length;a++)d=e[a],h.addViewHandler(d.view,d.viewEvents,d.path,d.viewHandler,d.options)}}})},themes:{via:{subThemes:j,bindingSet:P={}}}});y.viaEvent=function(a,b,d,e){if(!b.viewEvents)b.viewEvents={};a=e.split(",");for(d=0;d<a.length;d++)e=a[d].split("."),b.viewEvents[e[0]]=e[1]};g.expr[":"].via=
function(a){return!!g(a).attr("via")};A.view=function(){h.view(this.findAll(":via"));return this};g.fn.findAll=g.fn.findAll||function(a){if(0===this.length)return this;var b=this.filter(a);this.each(function(){b=b.add(g(this).find(a))});return b};g.fn.renderTemplate=function(a,b,d,e,f){return this.each(function(){function h(b){a&&(g(j)[a](b),b.view());k&&k.call(j,b)}var i,j=this,k=e&&(g.isFunction(e)?e:e.callback);"object"===typeof e?(e.callback=h,i=e):i=h;Aa(j,b,d,i,f)})};h.compileTemplate=function(a,
b,d){d=d||q.engine;if(!d)throw"there is not default engine registered";d=E[d];if(!d)throw"engine '"+d+"' can not be found.";return d.compileTemplate(a,b)};Ca.buildOptions=ha.buildOptions=function(a){return n(a)?(a=a.split(","),{templateId:g.trim(a[0]),engineName:a[1]}):a};i(w,{template:ha,templateOne:Ca});var E=h.templateEngines={};if(g.tmpl)q.engine="tmpl",E.tmpl={renderTemplate:function(a,b,d){return a.beginsWith("#")?g(a).tmpl(b,d):g.tmpl(a,b,d)},compileTemplate:function(a,b){g.template(a,b)},
isTemplateCompiled:function(a){return a.beginsWith("#")?!!g(a).length:!!g.template[a]}};else if(g.render)q.engine="jsrender",E.jsrender={renderTemplate:function(a,b,d){return a.beginsWith("#")?g(a).render(b,d):g.render(b,a,d)},compileTemplate:function(a,b){g.template(a,b)},isTemplateCompiled:function(a){return a.beginsWith("#")?!!g(a).length:!!g.views.templates[a]}};E.tmpl&&h.compileTemplate("ddl_tmpl","<option value='${this.value($data)}'>${this.name($data)}</option>");E.jsrender&&h.compileTemplate("ddl_jsrender",
"<option value='{{=$ctx.value($data)}}'>{{=$ctx.name($data)}}</option>","jsrender");i(w,{dropdown:i(function(a){w.template.call(this,a)},{buildOptions:function(a){var b=(a||"").split(","),a=1===b.length?{name:function(a){return a.toString()},value:function(a){return a.toString()},engine:a}:{name:function(a){return a[b[0]]},value:function(a){return a[b[1]]},engine:b[2]};a.templateId="ddl_"+(a.engine||q.engine);return a}}),pushViewItem:function(a){g(this).renderTemplate("append",a.options,a.targetValue())},
removeViewItem:function(a){g(this).children().eq(+a.targetIndex()).remove()},updateViewItem:function(a){g(this).children().eq(a.targetIndex()).renderTemplate("replaceWith",a.options,a.targetValue())},showIfTruthy:function(a){g(this)[a.isModelEmpty()?"hide":"show"]()},showIfFalsy:function(a){g(this)[a.isModelEmpty()?"show":"hide"]()},enableIfTruthy:function(a){g(this).attr("disabled",a.isModelEmpty())},enableIfFalsy:function(a){g(this).attr("disabled",!a.isModelEmpty())},val:function(a){a=a.currentValue();
a!==g(this).val()&&g(this).val(a)}});i(L,{value:function(a){return o(a.options)?a.options():a.options},evalOptions:function(a){return eval(a.options)},stringOptions:function(a){return a.options},numberOptions:function(a){return+a.options},trueValue:function(){return!0},falseValue:function(){return!1},toggle:function(a){return!a.targetValue()},trueIfCheck:function(){return this.checked},trueIfUncheck:function(){return!this.checked},returnFalse:function(a){a.returnFalse()},preventDefault:function(a){a.e.preventDefault()},
stopBubble:function(a){a.e.stopImmediatePropagation()}});i(ga,{toNumber:function(a){return+a},toDate:function(a){return new Date(a)},toString:function(a){return null===a||a===j?"":""+a}});P.simpleList="@mh:.,init|afterUpdate,*template;.,afterCreate.child,*pushViewItem;.,afterUpdate.child,*updateViewItem;.,afterDel.child,*removeViewItem,_";y.lookup=function(a,b,d,e){var e=/^(.+?)(,(.*))*$/.exec(e),f=b.path;d.mh.push({path:h.mergePath(b.path,e[1]),modelEvents:"init",view:a,modelHandler:"*dropdown",
options:e[3]});f&&(d.mh.push({path:b.path,modelEvents:"afterUpdate",view:a,modelHandler:"*val"}),d.vh.push({path:b.path,viewEvents:"change",view:a,viewHandler:"$val"}))};h.classMatchers.textBox=function(a){return g(a).is(":text")};i(P,{textBox:"@mh:.,init|after*,*val@vh:.,keyup,$val",label:"@mh:.,init|after*,$html"});q.errors={required:"This field is required.",email:"Please enter a valid email address.",url:"Please enter a valid URL.",date:"Please enter a valid date.",dateISO:"Please enter a valid date (ISO).",
...
min:"Please enter a value greater than or equal to {0}."};var Z=ma.invalidModelPaths=[],ka=h("*invalidModelPaths"),Wa=/^\s*$/,Ha=/^\d+$/,cb=/^(\/(\\[^\x00-\x1f]|\[(\\[^\x00-\x1f]|[^\x00-\x1f\\\/])*\]|[^\x00-\x1f\\\/\[])+\/[gim]*)(,(.*))$/,Q=/(\w+)(,(.*))?/,Ia=/(\w+),(\w+)(,(.*))?/;D.isValid=function(){var a=this.context+"*invalidated";if(k.get(a))return Da(this.context);k.create(a,!0);for(var b in p)if(b.beginsWith(this.context))for(var a=p[b],d=0;d<a.length;d++){var e=a[d];if("beforeUpdate"===e.modelEvents){s({path:b,
eventType:e.modelEvents,target:b,proposed:h().get(b)});s({path:b,eventType:"init",target:b});break}}return Da(this.context)};i(h.ModelEvent.prototype,{addError:function(a){this.currentProxy().createIfUndefined("*errors",[]).childProxy("*errors").pushUnique(a);ka.pushUnique(this.path)},removeError:function(a){this.currentProxy().createIfUndefined("*errors",[]).childProxy("*errors").removeItem(a).isModelEmpty()&&ka.removeItem(this.path)}});h.addValidator=function(a){if(O(a))for(var b=0;b<a.length;b++)h.addValidator(a[b]);
...
if(a&&(b=Q.exec(a)))return{minlength:+b[1],userError:b[3]};throw"invalid options for minlength validator";},buildError:G("minlength")},{name:"maxlength",isValid:function(a,b){return a.length<=b.maxlength},buildOptions:function(a){var b;if(a&&(b=Q.exec(a)))return{maxlength:+b[1],userError:b[3]};throw"invalid options for maxlength validator";},buildError:G("maxlength")},{name:"rangelength",isValid:function(a,b){return a.length>=b.minlength&&a.length<=b.maxlength},buildOptions:function(a){var b;if(a&&
(b=Ia.exec(a)))return{minlength:+b[1],maxlength:+b[2],userError:b[4]};throw"invalid options for rangelength validator";},buildError:G("minlength","maxlength")},{name:"min",isValid:function(a,b){return a>=b.min},buildOptions:function(a){var b;if(a&&(b=Q.exec(a)))return{min:+b[1],userError:b[3]};throw"invalid options for min validator";},buildError:G("min")},{name:"max",isValid:function(a,b){return a<=b.max},buildOptions:function(a){var b;if(a&&(b=Q.exec(a)))return{max:+b[1],userError:b[3]};throw"invalid options for max validator";
},buildError:G("max")},{name:"range",isValid:function(a,b){return a>=b.min&&a<=b.max},buildOptions:function(a){var b;if(a&&(b=Ia.exec(a)))return{min:+b[1],max:+b[2],userError:b[4]};throw"invalid options for range validator";},buildError:G("min","max")},{name:"equal",isValid:function(a,b){return k.get(b.path)===a},buildOptions:function(a){var b;if(a&&(b=Q.exec(a)))return{path:b[1],userError:b[3]};throw"invalid options for equal validator";}},{name:"regex",isValid:function(a,b){return b.regex.test(a)},
